...
**[Live Demo](https://your-app.vercel.app)** | **[Demo Video](https://loom.com/your-link)**
...
User question
  ...
  → Gemini 2.0 Flash (generateContentStream)
...
| LLM | Google Gemini `gemini-2.0-flash` (streaming) |
...
Open [http://localhost:5173](http://localhost:5173), sign up, paste a GitHub URL, and start asking.

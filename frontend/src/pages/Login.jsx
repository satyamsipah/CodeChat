...
import { ensureGuestSession } from '../utils/auth.js';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900">
      <div className="w-full max-w-md bg-slate-800 rounded-2xl p-8 shadow-xl">
        <Link to="/" className="text-sm text-slate-500 hover:text-slate-300 transition-colors mb-6 block">
          ← Back to home
        </Link>
        ...
        <div className="mt-3">
          <button
            type="button"
            onClick={handleGuest}
            className="w-full rounded-lg border border-slate-600 hover:border-slate-400 px-4 py-2.5 text-sm text-slate-300 hover:text-white transition-colors"
          >
            Continue as Guest
          </button>
        </div>
